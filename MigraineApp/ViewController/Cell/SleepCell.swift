...
class SleepCell: UITableViewCell {
    ...
    func setup(){
        imgView = UIImageView()
        imgView?.image = UIImage(named: "ic_sleep")
        ...
        imgEdit = UIImageView()
        imgEdit?.image = UIImage(named: "ic_notes")
        ...
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-8-[imgView(20)]-4-[lbDate(>=0)][lbInten(==lbDate)][lbDuration(==lbDate)]-[imgEdit(20)]-4-|", options: [], metrics: nil, views: viewsDict))
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-8-[imgView(20)]-8-|", options: [], metrics: nil, views: viewsDict))
        self.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-8-[imgEdit(20)]-8-|", options: [], metrics: nil, views: viewsDict))
